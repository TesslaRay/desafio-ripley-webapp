...
import * as fetchproductsActions from "../redux/actions/fetch-products.actions";
...
describe("Actions test", () => {
  ...
  test("dispatches FETCH_COUNT_SUCCESS after a successfull API requets", () => {
    ...
    const expectedActions = [
      { type: fetchproductsActions.FETCH_COUNT_REQUEST },
      {
        type: fetchproductsActions.FETCH_COUNT_SUCCESS,
        payload: [[]],
      },
    ];

    return store.dispatch(fetchproductsActions.fetchCount()).then(() => {
